...
// ErrorfCaller mocks base method.
func (m *MockLogger) ErrorfCaller(callerSkip int, template string, args ...interface{}) {
	m.ctrl.T.Helper()
	varargs := []interface{}{callerSkip, template}
	for _, a := range args {
		varargs = append(varargs, a)
	}
	m.ctrl.Call(m, "ErrorfCaller", varargs...)
}

// ErrorfCaller indicates an expected call of ErrorfCaller.
func (mr *MockLoggerMockRecorder) ErrorfCaller(callerSkip, template interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{callerSkip, template}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ErrorfCaller", reflect.TypeOf((*MockLogger)(nil).ErrorfCaller), varargs...)
}
